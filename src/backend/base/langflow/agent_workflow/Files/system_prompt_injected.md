  ...
  "data": {
    ...
    "node": {
      ...
      "outputs": [
        {
          "name": "model_response",
          "display_name": "Model Response(gys)",
          "types": [
            "Message"
          ],
...
{
  "id": "EditComponentTextOnly-<Need Edit!>",
  "data": {
...
{
  "id": "ALTK Agent-<Need Edit!>",
  "data": {
    "description": "Advanced agent with both pre-tool validation and post-tool processing capabilities.",
    "display_name": "ALTK Agent",
    "id": "ALTK Agent-<Need Edit!>",
    "selected_output": "<Need Edit!> (匹配\"outputs\"中元素的\"name\"字段)",
    "type": "ALTK Agent",
    "node": {
...

{
  "id": "Cuga-<Need Edit!>",
  "data": {
    "description": "Define the Cuga agent's policies, then assign it a task.",
    "display_name": "Cuga",
    "id": "Cuga-<Need Edit!>",
    "selected_output": "<Need Edit!> (匹配\"outputs\"中元素的\"name\"字段)",
    "type": "Cuga",
    "node": {
      "template": {
        ...
        "web_apps": {
          ...
          "name": "web_apps",
          "value": "<Need Edit!> (Edit or connected with other nodes' output)",
          "info": "Define a list of web applications that cuga will open when enable browser is true. Currently only supports one web application. Example: https://example.com",
          "type": "str",
          "input_types": [
            "Message"
          ],
