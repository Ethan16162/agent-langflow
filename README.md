...
- 基于Agent构建简单的问答系统：
<video src="files/Simple Agent1.mp4" controls width="600">
你的浏览器不支持 video 标签，请下载查看：<a href="files/Simple Agent1.mp4">Simple Agent</a>
</video>

- 基于Agent构建RAG系统aa：
<video src="files/RAG1.mp4" controls width="600">
你的浏览器不支持 video 标签，请下载查看：<a href="files/RAG1.mp4">RAG 示例</a>
</video>
